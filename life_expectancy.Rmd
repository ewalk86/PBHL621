...
```{r}
le_data <- read_csv("Data/testlifeexpectency.csv")
```
...
Since the data set contains 39 states across two genders and two races, first use
...
# What if we wanted to make a histogram... of life expectancy of White men in 2013?
...
- On Twitter using the #rstats hashta
